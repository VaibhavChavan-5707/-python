...
#======================== Table Frame ====================================================
    ...
    def add_students(self):
        if self.Roll_No_var.get()=="" or self.name_var.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost", user="root", password="pass", database="stm")
            my_cur = conn.cursor()
            my_cur.execute("insert into students values(%s,%s,%s,%s,%s,%s,%s)",(self.Roll_No_var.get(),
                                                                                self.name_var.get(),
                                                                                self.email_var.get(),
                                                                                self.gender_var.get(),
    ...
    def update_data(self):
        conn = mysql.connector.connect(host="localhost", user="root", password="pass", database="stm")
        my_cur=conn.cursor()
        my_cur.execute("update students set name=%s,email=%s,gender=%s,contact=%s,dob=%s,Address=%s where roll_no=%s",(
                                                                                                self.name_var.get(),
                                                                                                self.email_var.get(),
                                                                                                self.gender_var.get(),
                                                                                                self.contact_var.get(),
    ...
    def delete_data(self):
        conn = mysql.connector.connect(host="localhost", user="root", password="pass", database="stm")
        my_cur=conn.cursor()
        my_cur.execute("delete from students where roll_no=%s",self.Roll_No_var.get())
        conn.commit()
        conn.close()
        self.fetch_data()
        self.clear()
